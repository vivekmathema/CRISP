...
@ ECHO Example syntax:  run_console.bat crisp.pyc --run_session  cls_inf   --config_fpath  ./config/default.conf 
@ ECHO ========================================================================== 


%~dp0.\python3cpu_env\scripts\python.bat %* crisp.pyc --help
pause